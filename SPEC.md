...
### Dimensões
- `dim_candidato` — `sq_candidato` (chave TSE por eleição), `nome_urna`, `nome_completo`, `cpf_hash` (SHA-256 para linkar entre anos sem expor CPF), `genero`, `cor_raca`, `data_nascimento`, `grau_instrucao`, `ocupacao`.
